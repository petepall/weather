...
const weatherCodes: TWeatherCode = [
	{
		...
		'7': 'Dust or sand raised by wind at or near the station at the time of observation, but not well-developed dust whirl(s) or sand whirl(s)',
		...
		'34':
			'Severe duststorm or sandstorm - no appreciable change during the precedinghour',
		'35':
			'Severe duststorm or sandstorm - has begun or has increased during thepreceding hour',
		...
		'40':
			'Fog or ice fog at a a distance at the time of observation, but not atstation during the preceding hour',
		...
		'45':
			'Fog or ice fog, sky invisible, no appreciable change during the precedinghour',
		'46':
			'Fog or ice fog, sky visible, has begun or has become thicker duringpreceding hour',
		'47':
			'Fog or ice fog, sky invisible, has begun or has become thicker during thepreceding hour',
